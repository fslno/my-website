...
import { Phone, Mail, Instagram, Twitter, MessageSquare, X, Globe } from 'lucide-react';
...
export function Chatbot() {
  ...
  const getSocialIcon = (platform: string) => {
    switch (platform) {
      ...
      case 'TikTok': return <MessageSquare className="h-4 w-4" />; // Generic for TikTok if missing
