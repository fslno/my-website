...
export function BentoHero({ 
  ...
  // Authoritatively set pt-28 sm:pt-36 to clear the fixed Header + Announcement Banner
  if (isLoading) {
      ...
      <div className="w-full bg-primary overflow-hidden group shadow-2xl">
        <div className="relative h-[52.5vh] w-full">
          ...
          <div className={cn(
            ...
            <span className="hero-subheadline-color hero-subheadline-size text-[10px] uppercase tracking-[0.5em] font-bold mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
              {subheadline}
            </span>
