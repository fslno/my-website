...
export function BentoHero({ 
  ...
  return (
    <section className="pt-[76px] sm:pt-[104px] w-full bg-white min-h-[72vh]">
      {mounted && hasImages ? (
        <div className="w-full h-[72vh] overflow-hidden group shadow-2xl relative">
          <Carousel 
            setApi={setApi}
        ...
        <div className="w-full h-[72vh] bg-white" />
      )}
    </section>
  );
}
