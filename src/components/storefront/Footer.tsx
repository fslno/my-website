    ...
    <footer className="bg-black text-white py-12 mt-12">
      <div className="max-w-[1440px] mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2 space-y-6">
          <h2 className="text-3xl font-headline font-bold tracking-tighter uppercase text-white">
        ...
        <div className="space-y-6">
          ...
          <ul className="flex flex-col gap-3 text-[11px] font-bold uppercase tracking-widest text-white">
      ...
      <div className="max-w-[1440px] mx-auto px-4 border-t border-white/10 mt-12 pt-8 flex flex-col items-center gap-6 text-[9px] uppercase tracking-[0.2em] text-white text-center">
        <div className="flex flex-col items-center justify-center gap-6 w-full">
            ...
            <div className="flex flex-col items-center gap-1.5 group cursor-default">
              ...
              <div className="flex items-center gap-2">
                {config?.poweredByLogoUrl ? (
                  ...
                  <div className="w-5 h-5 bg-white/10 border border-white/20 rounded-sm flex items-center justify-center font-headline font-bold text-white text-[10px]">
                    F
                  </div>
                )}
                <span className="text-[10px] font-headline font-bold tracking-tighter text-white">
          ...
          <div className="space-y-1">
            ...
            <p className="text-white opacity-50">{config?.systemVersion || defaultVersion}</p>
          </div>
        </div>
      </div>
    </footer>
