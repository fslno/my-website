...
/**
 * Authoritative Root Layout with Global Hydration Guard.
 * Manifests a black-box boot interface to prevent hydration flashbacks.
 */
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={cn(
        "font-body antialiased m-0 p-0 min-h-screen",
        !mounted ? "bg-black flex items-center justify-center overflow-hidden" : "bg-background text-foreground"
      )}>
        {!mounted ? (
