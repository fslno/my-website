 ...
 * Implements a mounting guard to prevent hydration mismatches while ensuring
 * the basic HTML structure remains consistent across server and client.
 */
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <body className={cn("font-body antialiased bg-background text-foreground m-0 p-0", !mounted && "bg-black")}>
        {!mounted ? (
